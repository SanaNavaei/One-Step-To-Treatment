...
OSTT.out : $(BUILD_DIR)/template_parser.o $(BUILD_DIR)/response.o $(BUILD_DIR)/request.o $(BUILD_DIR)/utilities.o $(BUILD_DIR)/server.o $(BUILD_DIR)/route.o $(BUILD_DIR)/main.o $(BUILD_DIR)/OneStepToTreatment.o $(BUILD_DIR)/Bankcard.o $(BUILD_DIR)/Bill.o $(BUILD_DIR)/ChoosePackageHandler.o $(BUILD_DIR)/ChooseSupporterHandler.o $(BUILD_DIR)/Document.o $(BUILD_DIR)/HCD_Service.o $(BUILD_DIR)/HospitalClinicDoctor.o $(BUILD_DIR)/LoginHandler.o $(BUILD_DIR)/Patient.o $(BUILD_DIR)/PatientService.o $(BUILD_DIR)/PayMoneyHandler.o $(BUILD_DIR)/Request2.o $(BUILD_DIR)/SendInfoHandler.o $(BUILD_DIR)/SignupHandler.o $(BUILD_DIR)/Supporter.o $(BUILD_DIR)/SupporterService.o $(BUILD_DIR)/TreatmentPackageService.o $(BUILD_DIR)/TreatmentPackage.o $(BUILD_DIR)/TreatmentProcess.o $(BUILD_DIR)/handlers.o $(BUILD_DIR)/my_server.o $(BUILD_DIR)/errors.o $(BUILD_DIR)/DAO.o $(BUILD_DIR)/test.o 
	$(CC) $(CF) $(BUILD_DIR)/template_parser.o $(BUILD_DIR)/response.o $(BUILD_DIR)/request.o $(BUILD_DIR)/utilities.o $(BUILD_DIR)/server.o $(BUILD_DIR)/route.o $(BUILD_DIR)/main.o $(BUILD_DIR)/OneStepToTreatment.o $(BUILD_DIR)/Bankcard.o $(BUILD_DIR)/Bill.o $(BUILD_DIR)/ChoosePackageHandler.o $(BUILD_DIR)/ChooseSupporterHandler.o $(BUILD_DIR)/Document.o $(BUILD_DIR)/HCD_Service.o $(BUILD_DIR)/HospitalClinicDoctor.o $(BUILD_DIR)/LoginHandler.o $(BUILD_DIR)/Patient.o $(BUILD_DIR)/PatientService.o $(BUILD_DIR)/PayMoneyHandler.o $(BUILD_DIR)/Request2.o $(BUILD_DIR)/SendInfoHandler.o $(BUILD_DIR)/SignupHandler.o $(BUILD_DIR)/Supporter.o $(BUILD_DIR)/SupporterService.o $(BUILD_DIR)/TreatmentPackageService.o $(BUILD_DIR)/TreatmentPackage.o $(BUILD_DIR)/TreatmentProcess.o $(BUILD_DIR)/handlers.o $(BUILD_DIR)/my_server.o $(BUILD_DIR)/errors.o $(BUILD_DIR)/DAO.o $(BUILD_DIR)/test.o -o OSTT.out
